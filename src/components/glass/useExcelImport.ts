...
export function useExcelImport(packages: GlassPackage[], fetchPackages: () => void) {
  ...
  const downloadExcelTemplate = () => {
    ...
    const templateData = [
      ...
      ['', '', '', '', '', '', '', '', '', '', ''],
      ['', '№', 'Артикул', 'Наименование', 'Характеристики', 'Кол-во', 'Ед.', 'Цена', '', '', ''],
      ['', 1, 'GM-657', 'Крепление штанга-стекло', '[15*15мм, 90˚, PSS]', 1, 'шт', 1098.50, '', '', ''],
      ['', '', 'GM-658', 'Крепление штанга-стекло', '[15*15мм, 180˚, PSS]', 1, 'шт', 769.23, '', '', 'Аналог к позиции 1'],
      ['', '', 'TG-30-14B', 'Крепление штанга-стекло', '[30*10мм PSS]', 1, 'шт', 850, '', '', 'Аналог к позиции 1'],
      ['', 2, 'PS-2', 'Уплотнитель универсальный', '[8мм, 135˚, б/цв, 2200мм]', 1, 'шт', 250, '', '', ''],
      ['', '', 'PS-11', 'Уплотнитель универсальный', '[8мм, универсальный, б/цв, 2200мм]', 1, 'шт', 184.62, '', '', 'Аналог к позиции 2'],
      ['', 3, 'H-201', 'Ручка-скоба', '[L300мм, Хром]', 1, 'шт', 1846, '', '', ''],
      ['', '', '', '', '', '', '', '', '', '', ''],
      ['Инструкция:', '', '', '', '', '', '', '', '', '', ''],
      ['1. Строка 1: Артикул комплекта (ДКП-xxx) и название', '', '', '', '', '', '', '', '', '', ''],
      ['2. Основные компоненты: указываются с номером позиции (№)', '', '', '', '', '', '', '', '', '', ''],
      ['3. Аналоги: указываются БЕЗ номера позиции сразу после основного компонента', '', '', '', '', '', '', '', '', '', ''],
      ['4. Все столбцы обязательны: Артикул, Наименование, Характеристики, Кол-во, Ед., Цена', '', '', '', '', '', '', '', '', '', '']
    ];
